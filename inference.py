...
for i, scene in enumerate(scenes):
    ...
    #project_points(cfg, pipeline.depth_path, pipeline.conf_path, pipeline.rgb_path, os.path.join(cfg["output_path"],"Points"), pipeline.inference_dataset, scene)
    consensus_filter(cfg, pipeline.depth_path, pipeline.conf_path, pipeline.rgb_path, pipeline.output_path, pipeline.inference_dataset, scene)
